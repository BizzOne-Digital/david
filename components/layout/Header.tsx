      ...
      <div ref={headerStackRef} className="fixed inset-x-0 top-0 z-50">
        ...
        >
          <div className="container mx-auto px-3 md:px-4">
            <div className="flex min-h-[4rem] items-center gap-1 py-2 sm:min-h-[4.25rem] sm:gap-2 lg:hidden">
              <BrandLockup
            ...
            <div className="hidden h-16 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-4 py-2 lg:grid xl:h-[4.5rem]">
              <BrandLockup
                logoSrc={settings.logo || DEFAULT_LOGO}
                alt={settings.businessName}
                priority
