...
export const featuredProductsPage = [
  ...
  },
  {
    ...
    category: "AI Ghost Shopper",
    name: "The Lead Should Not Die Because Your Team Got Busy.",
    description:
      "Ghost Shopper A.I. captures the shoppers your store cannot see today — identifies interest, engages with relevance, and moves qualified customers toward appointments while management retains dashboard control.",
    features: [
